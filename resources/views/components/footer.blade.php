                ...
                <div class="flex w-1/3 justify-center">
                    <div class="text-[#555252]">
                        ...
                        <div class="flex flex-row text-sm ">
                                ...
                                <!-- Instagram -->
                                <a href="https://www.instagram.com/lensandlight.id/" target="_blank" class="w-9 h-9 mr-3 rounded-full border flex justify-center items-center text-white hover:border-blue-950 hover:bg-[#EFEFE9] hover:text-slate-950">
                                ...
                                <!-- Tiktok -->
                                <a href="https://www.tiktok.com/@lensandlight.id" target="_blank" class="w-9 h-9 mr-3 rounded-full border flex justify-center items-center text-white hover:border-blue-950 hover:bg-[#EFEFE9] hover:text-slate-950">
