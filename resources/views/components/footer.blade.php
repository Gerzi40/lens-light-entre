    ...
    <div class="flex flex-wrap h-48">
        ...
        <div class="flex flex-col w-3/4"> 
                ...
                <div class="flex w-1/3 justify-center">
                    <div class="">
                        ...
                        <div class="flex flex-row text-sm ">
                                <!-- Face -->
                                <a href="#" target="_blank" class="w-9 h-9 mr-3 rounded-full border flex justify-center items-center text-white hover:border-blue-950 hover:bg-blue-950 hover:text-slate-950">
                                ...
                                <!-- Instagram -->
                                <a href="https://www.instagram.com/lensandlight.id/" target="_blank" class="w-9 h-9 mr-3 rounded-full border flex justify-center items-center text-white hover:border-blue-950 hover:bg-blue-950 hover:text-slate-950">
                                ...
                                <!-- Tiktok -->
                                <a href="https://www.tiktok.com/@lensandlight.id" target="_blank" class="w-9 h-9 mr-3 rounded-full border flex justify-center items-center text-white hover:border-blue-950 hover:bg-blue-950 hover:text-slate-950">
            ...
            <div class="w-full h-1/2 flex items-center justify-center">
                <h3 class="text-neutral-600">© 2024 lens&light. All rights reserved.</h3>
            </div>
        </div>
    </div>
</footer>