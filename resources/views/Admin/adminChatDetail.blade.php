    ...
    <div class="sm:p-6 flex flex-col" id="chat" style="height: calc(100vh - 60px); ">
        ...
        <div class="flex items-center justify-between py-3 border-b-2 border-gray-200">
            <div class="relative flex items-center space-x-4">
                <a href="/adminChat" class="flex flex-col items-center">
                ...
                <img src="/profile_picture/default.jpg" alt="" class="w-10 sm:w-16 h-10 sm:h-16 rounded-full">
                </div>
                <div class="flex flex-col leading-tight">
                    <div class="text-2xl mt-1 flex items-center">
                        <span class="text-gray-700 mr-3">{{ $chatRoom->user->username }}</span>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    const lengths = document.getElementById('messages')
